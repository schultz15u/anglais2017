...
public class MenuButtonsListener implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (menuReference.getMenuButtons().get(3).equals(e.getSource())){
			menuReference.switchScreen(menuReference.getMenuButtons().get(3).getText());
		}
		if (menuReference.getMenuButtons().get(4).equals(e.getSource())){
			menuReference.switchScreen(menuReference.getMenuButtons().get(4).getText());
		}
		if (menuReference.getMenuButtons().get(5).equals(e.getSource())){
			menuReference.switchScreen(menuReference.getMenuButtons().get(5).getText());
		}
		if (menuReference.getMenuButtons().get(5).equals(e.getSource())){
